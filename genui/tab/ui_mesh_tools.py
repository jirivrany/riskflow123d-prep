...
#
# Created: Thu Jan 03 14:46:30 2013
...
class Ui_MeshTools(object):
    def setupUi(self, MeshTools):
        ...
        self.edit_multiply_storativity = QtGui.QLineEdit(self.groupBox_2)
        self.edit_multiply_storativity.setObjectName(_fromUtf8("edit_multiply_storativity"))
        self.gridLayout_3.addWidget(self.edit_multiply_storativity, 0, 1, 1, 1)
        self.button_multiply_storativity = QtGui.QPushButton(self.groupBox_2)
        self.button_multiply_storativity.setObjectName(_fromUtf8("button_multiply_storativity"))
        self.gridLayout_3.addWidget(self.button_multiply_storativity, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.edit_nvalue_storativity, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.button_nvalue_storativity, 1, 2, 1, 1)
        ...
        self.edit_multiply_porosity = QtGui.QLineEdit(self.groupBox_3)
        self.edit_multiply_porosity.setObjectName(_fromUtf8("edit_multiply_porosity"))
        self.gridLayout_4.addWidget(self.edit_multiply_porosity, 0, 1, 1, 1)
        self.button_multiply_porosity = QtGui.QPushButton(self.groupBox_3)
        self.button_multiply_porosity.setObjectName(_fromUtf8("button_multiply_porosity"))
        self.gridLayout_4.addWidget(self.button_multiply_porosity, 0, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.edit_nvalue_porosity, 1, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.button_nvalue_porosity, 1, 2, 1, 1)
    ...
    def retranslateUi(self, MeshTools):
        ...
        self.label_11.setText(_translate("MeshTools", "Multiply Storativity by:", None))
        self.button_multiply_storativity.setText(_translate("MeshTools", "OK", None))
        ...
        self.label_13.setText(_translate("MeshTools", "Multiply Dual Porosity by:", None))
        self.button_multiply_porosity.setText(_translate("MeshTools", "OK", None))
